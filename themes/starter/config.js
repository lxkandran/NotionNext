...
const CONFIG = {
  ...
  STARTER_HERO_BUTTON_1_TEXT: '微信公众号', // 英雄区按钮
  STARTER_HERO_BUTTON_1_URL:
    'https://www.fyss.top/wxgzh', // 英雄区按钮
  STARTER_HERO_BUTTON_2_TEXT: '扫码关注', // 英雄区按钮
  STARTER_HERO_BUTTON_2_URL: 'https://www.fyss.top/wxgzh', // 英雄区按钮
  ...
  STARTER_FAQ_TEXT_2: '我们收集了常见的诗友疑问',

  STARTER_FAQ_1_QUESTION: '如果上稿《扶摇诗刊》，发放稿费么？',
  STARTER_FAQ_1_ANSWER:
    '暂时没有稿费，后续规划发放稿费。《扶摇诗刊》自2024年5月4日发起以来，秉承“不厚名家、不薄新人”的原则，致力于为广大诗歌爱好者提供一个展示才华的平台。一经录用，赠电子样刊。',

  STARTER_FAQ_2_QUESTION: '审稿周期长么？',
  ...
  STARTER_BLOG_TITLE: '我们的新闻',
  STARTER_BLOG_COUNT: 3, // 首页博文区块默认展示前3篇文章
  STARTER_BLOG_TEXT_1: '最近的动态',
  STARTER_BLOG_TEXT_2:
    '若有对《扶摇诗刊》新栏目的想法建议，或者想要合作/赞助/咨询/互相推广公众号/其他事宜，请发邮箱：jungu2023@163.com或添加微信：fuyaoshikan。',
  ...
  STARTER_POST_REDIRECT_URL: 'https://www.fyss.top', // 重定向域名
